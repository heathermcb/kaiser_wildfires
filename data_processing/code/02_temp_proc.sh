...
declare -a years=($(seq 2016 2019))
declare -a dnames=("tmean")
declare -a times=("daily")
declare -a spaces=("zip")
# also "zip" for 2015-2017 when done (above)
declare -a states=("06")
...
Rscript /Users/heathermcbrien/Documents/GitHub.nosync/kaiser_wildfires/data_processing/code/xx_temp_proc_zcta_new.R $year $dname $time $space $state &
